...
def get_context(context):
    # This configures the Project Portal Timesheets child route.
    if frappe.session.user == "Guest":
        frappe.local.flags.redirect_location = (
            "/login?redirect-to=/shayona/projects/timesheets"
        )
    ...
    context.portal_page = "timesheets"
    context.portal_title = "Timesheets"
