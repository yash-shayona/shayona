...
def get_context(context):
    # This configures the refresh-safe Projects listing route.
    if frappe.session.user == "Guest":
        frappe.local.flags.redirect_location = "/login?redirect-to=/shayona/projects"
    ...
    context.portal_page = "projects"
    context.portal_title = "Projects"
