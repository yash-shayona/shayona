...
def get_context(context):
    # This configures the Project Portal Dashboard child route.
    if frappe.session.user == "Guest":
        frappe.local.flags.redirect_location = (
            "/login?redirect-to=/shayona/projects/dashboard"
        )
    ...
    context.portal_page = "dashboard"
    context.portal_title = "Project Dashboard"
